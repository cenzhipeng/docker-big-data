...
# 基础 ssh 服务
RUN yum install passwd openssl openssh-server openssh-clients sudo java-1.8.0-openjdk which -y
...
# path
RUN echo 'export JAVA_HOME=$(ls -d /usr/lib/jvm/java-1.8.0-*)' >> /home/hadoop/.bashrc
